...
- [x] 2.1 创建 `myspec/changes/archive/2026-06-16-baseline-agent-guard-docs-migration/source-docs/` 归档目录。
...
- [x] 4.1 更新 `AGENTS.md`，让当前契约入口指向 `myspec/specs/**`，并移除对 5 个旧目录的文档落盘要求。
...
- [x] 5.1 运行 `myspec validate --all --strict --json`。
...
- [x] 5.5 检查 `git diff -- docs AGENTS.md tests plugins myspec`，确认 diff（差异）符合本 change 范围。
