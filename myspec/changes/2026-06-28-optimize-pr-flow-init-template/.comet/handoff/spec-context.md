...
- Phase: design
- Mode: beta
- Context hash: 87ce12bf3bf1782a5d73d8d4010d372b380bc5848209f46ab6ef5f7ad93096cb
...
- Source: myspec/changes/optimize-pr-flow-init-template/proposal.md
- SHA256: fca1d8dc164ed276f85c9183918e8e659c47ad9949f6a15e63cdc303642cc48b
- Source: myspec/changes/optimize-pr-flow-init-template/design.md
- SHA256: 1489104cce501a669098b48acbc35aa52078088ec2d8c4cbb751621c240463ab
- Source: myspec/changes/optimize-pr-flow-init-template/tasks.md
- SHA256: 59b0f7af58a9f6b1883e2b0f9f8694933d795a8ed5cc1459b3b079e7cbf64174
- Source: myspec/changes/optimize-pr-flow-init-template/specs/pr-flow-plugin/spec.md
- SHA256: bd00e252fe0a18732840b5a4be6a283906c90efd80426ccb13cf57420c79ebae

## Acceptance Projection

## myspec/changes/optimize-pr-flow-init-template/specs/pr-flow-plugin/spec.md
...
- **THEN** agent（代理）MUST ask only one question at a time and wait for the answer before asking the next question
...
- **THEN** branch protection（分支保护）options MUST be derived from inspected remote branches（远端分支） instead of hard-coded branch names
- **THEN** choosing no remote branch protection MUST NOT derive `defaults.reviewGate.mode: github`
- **THEN** questionnaire（问答模板）MUST ask whether PR status checks（拉取请求状态检查） are required
- **THEN** each selectable PR status check（拉取请求状态检查） MUST include its workflow/job source（工作流/任务来源）, validation purpose（验证内容）, and failure impact（失败影响）
