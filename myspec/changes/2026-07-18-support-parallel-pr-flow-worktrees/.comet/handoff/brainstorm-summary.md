...
- MySpec（自有规格）是需求事实源，当前交接包哈希为 `441c17c22d300c23253e6181953f30d273f86c0078c1cc0fa96fe7a556c2c4e1`。
...
- 完整验证使用仓库现有 Build and Verify（构建与验证）入口，并运行 Plugin（插件）打包测试与 MySpec（自有规格）严格校验。
