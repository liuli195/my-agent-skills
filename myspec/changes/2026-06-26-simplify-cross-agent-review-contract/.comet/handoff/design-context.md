...
## myspec/changes/simplify-cross-agent-review-contract/proposal.md

- Source: myspec/changes/simplify-cross-agent-review-contract/proposal.md
- Lines: 1-36
...
## myspec/changes/simplify-cross-agent-review-contract/design.md

- Source: myspec/changes/simplify-cross-agent-review-contract/design.md
- Lines: 1-125
...
- `tasks_file` points to MySpec tasks, but the actual implementation guidance is better represented by a Superpowers plan.
...
```json
{
  ...
  "spec_file": "myspec/changes/<change>/specs/<capability>/spec.md",
...
`plan_file` points to the Superpowers implementation plan. MySpec `tasks.md` remains the planning artifact for this change workflow, but it is no longer part of the review input contract.
...
Full source: myspec/changes/simplify-cross-agent-review-contract/design.md

## myspec/changes/simplify-cross-agent-review-contract/tasks.md

- Source: myspec/changes/simplify-cross-agent-review-contract/tasks.md
- Lines: 1-34
...
## myspec/changes/simplify-cross-agent-review-contract/specs/cross-agent-review/spec.md

- Source: myspec/changes/simplify-cross-agent-review-contract/specs/cross-agent-review/spec.md
- Lines: 1-165
...
Full source: myspec/changes/simplify-cross-agent-review-contract/specs/cross-agent-review/spec.md
