...
- MySpec tasks: foundation for `3.3`
...
### Task 11: End-To-End Regression And MySpec Closure

- MySpec tasks: `8.1`, `8.2`, `8.3`, `8.4`
- Verification evidence: focused pytest passed with 52 tests; `python scripts/check.py build` passed; `myspec validate add-pr-flow-plugin --type change --strict` passed; final `python scripts/check.py verify` passed with 322 tests.
- Fix commit: cf25cba
