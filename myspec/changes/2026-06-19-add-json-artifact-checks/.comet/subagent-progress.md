...
- MySpec task: 3.1 Include JSON check failure details in runtime audit output; 3.2 Run focused Agent Guard runtime and validator tests.
- Stage: implemented
- Round: 1
...
- Spec review: `myspec validate add-json-artifact-checks --strict` -> valid
