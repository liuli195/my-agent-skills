...
- Do not modify `docs/rules/`. Test-writing guidance for this change stays in MySpec artifacts unless the user later confirms another location.
...
- Completed in `myspec/changes/optimize-full-verification-runtime/specs/full-verification-runtime/spec.md`.
