...
- Fix evidence: RED `python -m pytest tests/test_agent_guard_plugin_installer.py -q` failed with 2 failed, 8 passed; GREEN installer tests passed with 10 passed; focused verification passed with 24 passed; MySpec strict validation passed with 6 valid, failed 0.
