...
MySpec remains the canonical capability spec. This handoff is a deterministic, source-traceable context pack, not an agent-authored summary.

## myspec/changes/agent-guard-marketplace-subscription/proposal.md

- Source: myspec/changes/agent-guard-marketplace-subscription/proposal.md
- Lines: 1-36
...
- 更新相关测试和 MySpec specs，使验证不再引用旧用户级 Skill 安装兼容层。
...
- `myspec/specs/agent-guard-plugin-runtime/spec.md`
- `myspec/specs/agent-guard-skill-entrypoints/spec.md`
```

## myspec/changes/agent-guard-marketplace-subscription/design.md

- Source: myspec/changes/agent-guard-marketplace-subscription/design.md
- Lines: 1-118
...
- 更新 MySpec specs、安装器、测试和文档，删除旧 user-level Skill/Junction 契约。
...
Full source: myspec/changes/agent-guard-marketplace-subscription/design.md

## myspec/changes/agent-guard-marketplace-subscription/tasks.md

- Source: myspec/changes/agent-guard-marketplace-subscription/tasks.md
- Lines: 1-26
...
- [ ] 4.1 运行 `myspec validate --all --strict --json`。
...
## myspec/changes/agent-guard-marketplace-subscription/specs/agent-guard-plugin-runtime/spec.md

- Source: myspec/changes/agent-guard-marketplace-subscription/specs/agent-guard-plugin-runtime/spec.md
- Lines: 1-59
...
## myspec/changes/agent-guard-marketplace-subscription/specs/agent-guard-skill-entrypoints/spec.md

- Source: myspec/changes/agent-guard-marketplace-subscription/specs/agent-guard-skill-entrypoints/spec.md
- Lines: 1-25
