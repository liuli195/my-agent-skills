...
- Phase: design
- Mode: beta
- Context hash: bc417a65eafbd0f44ee3bd7b62808bf821a94648f1204aec72121b5ab993f640
...
- SHA256: 2573ecb00df03ab9ace4ccd025d1b3b03df3a9fa4ad402c9f75f9e965d568ca7
- Source: openspec/changes/optimize-pr-flow-init-template/design.md
- SHA256: ba96146cc5b8b3a937d61c18a3a09ee81cac78829642b03adca4bc6e7feeb63f
- Source: openspec/changes/optimize-pr-flow-init-template/tasks.md
- SHA256: aa34f0b73e6f8e30959999416b24c8cf24dace02c0b50d3062b377630f894768
- Source: openspec/changes/optimize-pr-flow-init-template/specs/pr-flow-plugin/spec.md
- SHA256: 610262eed1dbce07a7fd3791f0ca0d824b032dbeb50056d08ad73b267f639d97
...
- **THEN** 用户场景 MUST 覆盖 automatic inspection（自动检查）、default PR target branch（默认拉取请求目标分支）、branch protection（分支保护）、PR status checks（拉取请求状态检查）、hotfix（热修复）、merge methods（合并方式）、GitHub（代码托管平台）远端配置建议和最终写入确认
