...
```powershell
python skills\agent-guard\scripts\install_hooks.py --project <target-project> --profile <guard-profile-id>
```
...
```powershell
python skills\agent-guard\scripts\install_hooks.py --project <target-project> --profile <guard-profile-id> --verify
```
