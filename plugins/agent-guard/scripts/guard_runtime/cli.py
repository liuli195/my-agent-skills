...
def build_parser() -> argparse.ArgumentParser:
    ...
    activate_parser.add_argument("--source", required=True, choices=["codex", "claude", "pi"])
    ...
    completed_parser.add_argument("--source", required=True, choices=["codex", "claude", "pi"])
    ...
    brief_parser.add_argument("--source", required=True, choices=["codex", "claude", "pi"])
